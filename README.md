...
<body>  
    ...
    <div id="sideNav" class="side-nav">
        ...
        <div class="nav-item" onclick="toggleSubMenu('doubtSub', 'arrow1')">
            ...
            <i class="fas fa-chevron-right" id="arrow1" style="margin-left:auto; font-size:12px; transition:0.3s;"></i>
        </div>
        <div id="doubtSub" class="sub-menu">
            <div style="padding:10px; color:#cbd5e1;" onclick="alert('Class 11 Community Soon')">● Class 11 Group</div>
            <div style="padding:10px; color:#cbd5e1;" onclick="alert('Class 12 Community Soon')">● Class 12 Group</div>
        </div>

        <div class="nav-item" onclick="toggleSubMenu('socialSub', 'arrow2')">
            <i class="fas fa-share-alt" style="color:#38bdf8;"></i><span>Social Media</span>
